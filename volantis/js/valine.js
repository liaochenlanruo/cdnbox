! function (e, t) {
    ...
    return function (e) {
        ...
        r = function (e, t) {
            ...
            var a = null;
            "undefined" == typeof window || "function" != typeof window.getComputedStyle ? ((a =
                function (e) {
                    return e
                }).destroy = function (e) {
                return e
                ...
                return e && Array.prototype.forEach.call(e.length ? e : [e], function (
                    e) {
                    return function (e) {
                        function t(t) {
                            var n = e.style.width;
                            e.style.width = "0px", e.offsetWidth, e.style.width =
                                n, e.style.overflowY = t
                        }
                        ...
                        function n() {
                            if (0 !== e.scrollHeight) {
                                ...
                                e.style.height = "", e.style.height = e.scrollHeight +
                                    a + "px", s = e.clientWidth, t.forEach(
                                        function (e) {
                        ...
                        function r() {
                            ...
                            var r = Math.round(parseFloat(e.style.height)),
                                ...
                                a = "content-box" === i.boxSizing ? Math.round(
                                    parseFloat(i.height)) : e.offsetHeight;
                            if (a < r ? "hidden" === i.overflowY && (t(
                                        "scroll"), n(), a = "content-box" ===
                                    i.boxSizing ? Math.round(parseFloat(
                                        window.getComputedStyle(e, null)
                                        .height)) : e.offsetHeight) :
                                "hidden" !== i.overflowY && (t("hidden"), n(),
                                    a = "content-box" === i.boxSizing ?
                                    Math.round(parseFloat(window.getComputedStyle(
                                        e, null).height)) : e.offsetHeight),
                                l !== a) {
                                l = a;
                        ...
                        if (e && e.nodeName && "TEXTAREA" === e.nodeName &&
                            ...
                            var a = null,
                                ...
                                d = function (t) {
                                    window.removeEventListener("resize", c,
                                            ...
                                            "input", r, !1), e.removeEventListener(
                                            "keyup", r, !1), e.removeEventListener(
                                            "autosize:destroy", d, !1), e.removeEventListener(
                                            "autosize:update", r, !1),
                            ...
                            e.addEventListener("autosize:destroy", d, !1),
                                "onpropertychange" in e && "oninput" in e &&
                                e.addEventListener("keyup", r, !1), window.addEventListener(
                                    "resize", c, !1), e.addEventListener(
                                    "input", r, !1), e.addEventListener(
                                    "autosize:update", r, !1), e.style.overflowX =
                                "hidden", e.style.wordWrap = "break-word",
                                i.set(e, {
                                    destroy: d,
                                    update: r
                                }),
                                function () {
                                    ...
                                    "vertical" === t.resize ? e.style.resize =
                                        "none" : "both" === t.resize && (e.style
                                            .resize = "horizontal"), a =
        ...
        r.prototype.init = function (e) {
            var t = this;
            if (t.config = e, "undefined" != typeof document) return "undefined" == typeof AV ? u.dynamicLoadSource(
                "script", {
            ...
            try {
                ...
                z = e.config.serverURLs || T + "avoscloud.com", M !== AV._config.applicationId && C !==
                    AV._config.applicationKey && AV.init({
                        appId: M,
                        appKey: C,
                        serverURLs: z
                    });
                ...
                e.el = j, e.el.classList.add("v"), m.hide && e.el.classList.add("hide-avatar"), e.config
                ...
                e.loading = {
                    show: function (t) {
                        ...
                        return t ? N.insertBefore(I, n[0]) : N.appendChild(I), e.nodata.hide(),
                            e
                    },
                    hide: function () {
                        var t = u.find(N, ".vloading");
                        return t && u.remove(t), 0 === u.findAll(N, ".vcard").length && e.nodata
                            .show(), e
                    }
                };
                ...
                e.alert = {
                    show: function (t) {
                        Q.innerHTML = '<div class="valert txt-center"><div class="vtext">' +
                            ...
                            e.length > 0 && u.each(e, function (e, t) {
                                var n = t.get("url"),
                                    ...
                                    i = u.findAll(document,
                                        '.leancloud_visitors[id="' + n +
                                        '"],.leancloud-visitors[id="' + n + '"]');
        ...
        r.prototype.Q = function (e) {
            ...
            if (t.el && t.loading.hide().nodata.hide(), "[object Error]" === {}.toString.call(e)) {
                ...
                101 == n ? t.nodata.show() : t.el && t.nodata.show(
                    '<pre style="text-align:left;">Code ' + n + ": " + r + "</pre>") || console
                    ...
                    return u.each(n, function (e, t) {
                        1 === t.nodeType && (r.indexOf(t.nodeName) > -1 && ("INPUT" === t.nodeName &&
                                "checkbox" === u.attr(t, "type") ? u.attr(t, "disabled",
                                    "disabled") : u.remove(t)), "A" === t.nodeName &&
                            function (e, t) {
                                var n = u.attr(e, t);
            ...
            var E = function (e, t) {
                    if (document.selection) e.focus(), document.selection.createRange().text = t, e
                        .focus();
                ...
                e > 0 ? (u.attr(u.find(t.el, ".vinfo"), "style", "display:block;"), u.find(
                    ...
                    function e() {
                        ...
                        o.limit(r), o.skip((n - 1) * r), o.find().then(function (o) {
                            ...
                            d.innerHTML = r * n < i ?
                                '<button type="button" class="vmore vbtn">' + t
                                .locale.ctrl.more + "</button>" : "";
            ...
            var M = function (e, n, r) {
                    var i = u.create("div", {
                        ...
                        s = e.get("ua") || "",
                        l = "";
                    s && (l = '<span class="vsys">' + (s = d(s)).browser + " " + s.version +
                            '</span> <span class="vsys">' + s.os + " " + s.osVersion + "</span>"),
                        "*" === y && (l = '<a href="' + e.get("url") + '" class="vsys">' + e.get(
                            "url") + "</a>");
                    var p, f = e.get("link") || "";
                    f.indexOf(".") > 0 && f.indexOf("://") < 0 && (f = "http://" + f), p = f ?
                        '<a class="vnick" rel="nofollow" href="' + f + '" target="_blank" >' + e.get(
                            "nick") + "</a>" : '<span class="vnick">' + e.get("nick") + "</span>",
            ...
            var j = u.find(t.el, ".vsubmit"),
                B = function (e) {
                    return u.attr(j, "disabled") ? void t.alert.show({
                        ...
                        }) : "" == v.comment ? void _.comment.focus() : "" == v.nick ? void _.nick.focus() :
                        "" == v.mail ? void _.mail.focus() : (v.nick = v.nick || "Anonymous", void(
                            t.notify || t.verify ? I(U) : U()))
                },
                P = function () {
                    var e = new AV.ACL;
                ...
                U = function () {
                    ...
                    if (v.url = decodeURI(n), v.insertedAt = new Date, T.rid) {
                        var r = T.pid || T.rid;
                        e.set("rid", T.rid), e.set("pid", r), v.comment = v.comment.replace("<p>",
                    ...
                    for (var i in v)
                        ...
                        try {
                            if (T.rid) {
                                var i = u.find(t.el, '.vquote[rid="' + T.rid + '"]') || L(T
                                    .rid);
                                M(e, i, !0)
                            } else n ? (r = Number(n.innerText) + 1, n.innerText = r) : u.find(
                                    t.el, ".vcount").innerHTML =
                                '<span class="num">1</span> ' + t.locale.tips.comments, M(e,
                                    u.find(t.el, ".vlist"));
                            v.mail && N({
                                    username: v.nick,
                                    mail: v.mail
                                    ...
                                    mail: T.rmail
                                }), u.removeAttr(j, "disabled"), t.loading.hide(), v.comment =
                                "", _.comment.value = "", w(_.comment), u.attr(_.comment,
                                    "placeholder", t.placeholder), T = {}, t.preview.empty()
                                .hide()
                        } catch (e) {
                            t.ErrorHandler(e)
                        }
                ...
                I = function e(n) {
                    var r = Math.floor(10 * Math.random() + 1),
                        ...
                        a = ["+", "-", "x"],
                        s = "" + r + a[Math.floor(3 * Math.random())] + i + a[Math.floor(3 * Math.random())] +
                        o,
                    ...
                    t.alert.show({
                        ...
                        cb: function () {
                            ...
                            new Function("return " + s.replace(/x/g, "*"))() === r ? n &&
                                n() : t.alert.show({
                                    type: 1,
            ...
            u.on("click", j, B), u.on("keydown", document, function (e) {
                ...
                (e.ctrlKey || e.metaKey) && 13 === t && B(), 9 === t && "veditor" == (
            ...
            return new function (e) {
                var t = this,
                    n = {
                        ...
                        "Windows Phone": e.indexOf("IEMobile") > -1 || e.indexOf(
                            "Windows Phone") > -1,
                        ...
                        Mobile: e.indexOf("Mobi") > -1 || e.indexOf("iPh") > -1 || e.indexOf(
                            "480") > -1,
                ...
                var r = {
                    ...
                    os: ["Windows", "Linux", "Mac OS", "Android", "Ubuntu", "FreeBSD",
                        "Debian", "iOS", "Windows Phone", "BlackBerry", "MeeGo",
                ...
                var l = {
                    ...
                    IE: function () {
                        return e.replace(/^.*MSIE ([\d.]+).*$/, "$1").replace(
                            /^.*rv:([\d.]+).*$/, "$1")
                    },
                    Edge: function () {
                ...
                t.version = "", l[t.browser] && (t.version = l[t.browser](), t.version == e &&
                        (t.version = "")), "Edge" == t.browser ? t.engine = "EdgeHTML" :
                    "Chrome" == t.browser && parseInt(t.version) > 27 ? t.engine = "Blink" :
                    "Opera" == t.browser && parseInt(t.version) > 12 ? t.engine = "Blink" :
                    "Yandex" == t.browser ? t.engine = "Blink" : void 0 == t.browser && (t.browser =
                        "Unknow App")
            }(e)
        }
    }, function (e, t, n) {
            ...
            p = {
                ...
                dynamicLoadSource: function (e, t, n) {
                    ...
                    if (p.find(i, e + "[" + r + '="' + t[r] + '"]')) "function" == typeof n && n();
                        ...
                        var o = p.create(e, t);
                        i.getElementsByTagName("head")[0].appendChild(o), o.onload = o.onreadystatechange =
                            function () {
                                this.onload = this.onreadystatechange = null, "function" == typeof n &&
                                    n()
                            }
                    }
                },
                on: function (e, t, n, r) {
                    for (var i = 0, o = (e = e.split(" ")).length; i < o; i++) p.off(e[i], t, n, r),
                        t.addEventListener ? t.addEventListener(e[i], n, r || !1) : t.attachEvent ?
                        t.attachEvent("on" + e[i], n) : t["on" + e[i]] = n
                },
                off: function (e, t, n, r) {
                    for (var i = 0, o = (e = e.split(" ")).length; i < o; i++) t.removeEventListener ?
                        t.removeEventListener(e, n, r || !1) : t.detachEvent ? t.detachEvent("on" +
                            e, n) : t["on" + e] = null
                },
                escape: function (e) {
        ...
        ! function (i) {
            ...
            function u(e, t) {
                ...
                var n, r, i, a, u, p = 1732584193,
                    ...
                    h = -1732584194,
                    v = 271733878;
                for (n = 0; n < e.length; n += 16) r = p, i = f, a = h, u = v, f = d(f = d(f = d(f = d(
                        f = c(f = c(f = c(f = c(f = l(f = l(f = l(f = l(f = s(f = s(f = s(f =
                                                        s(f, h = s(h, v = s(v,
                                                                    p = s(p, f,
                                                                        h, v, e[
                                                                            n],
                                                        ...
                                                        e[n + 10], 17, -42063),
                                                    v, p, e[n + 11], 22, -
                                                    1990404162), h = s(h, v = s(
                                                    v, p = s(p, f, h, v, e[
                                                            n + 12], 7,
                                                        1804603682), f, h,
                                                    e[n + 13], 12, -
                                                    40341101), p, f, e[n +
                                                    14], 17, -1502002290), v, p,
                                                e[n + 15], 22, 1236535329), h =
                                            l(h, v = l(v, p = l(p, f, h, v, e[n +
                                                        1], 5, -165796510), f,
                                                    h, e[n + 6], 9, -1069501632
                                                ), p, f, e[n + 11], 14,
                                                643717713), v, p, e[n], 20, -
                                            373897302), h = l(h, v = l(v, p = l(
                                                    p, f, h, v, e[n + 5], 5, -
                                                    701558691), f, h, e[n + 10],
                                                9, 38016083), p, f, e[n + 15],
                                            14, -660478335), v, p, e[n + 4], 20,
                                        -405537848), h = l(h, v = l(v, p = l(p,
                                            f, h, v, e[n + 9], 5, 568446438
                                        ), f, h, e[n + 14], 9, -1019803690), p,
                                        f, e[n + 3], 14, -187363961), v, p, e[n +
                                        8], 20, 1163531501), h = l(h, v = l(v, p =
                                        l(p, f, h, v, e[n + 13], 5, -1444681467),
                                        f, h, e[n + 2], 9, -51403784), p, f, e[
                                        n + 7], 14, 1735328473), v, p, e[n + 12],
                                    20, -1926607734), h = c(h, v = c(v, p = c(p, f,
                                        h, v, e[n + 5], 4, -378558), f, h, e[n +
                                        8], 11, -2022574463), p, f, e[n + 11], 16,
                                    1839030562), v, p, e[n + 14], 23, -35309556), h = c(
                                    h, v = c(v, p = c(p, f, h, v, e[n + 1], 4, -
                                        1530992060), f, h, e[n + 4], 11, 1272893353), p,
                                    f, e[n + 7], 16, -155497632), v, p, e[n + 10], 23,
                                -1094730640), h = c(h, v = c(v, p = c(p, f, h, v, e[n +
                                    13], 4, 681279174), f, h, e[n], 11, -358537222), p,
                                f, e[n + 3], 16, -722521979), v, p, e[n + 6], 23,
                            76029189), h = c(h, v = c(v, p = c(p, f, h, v, e[n + 9], 4,
                            -640364487), f, h, e[n + 12], 11, -421815835), p, f, e[
                            n + 15], 16, 530742520), v, p, e[n + 2], 23, -995338651), h = d(
                            h, v = d(v, p = d(p, f, h, v, e[n], 6, -198630844), f, h, e[n +
                                7], 10, 1126891415), p, f, e[n + 14], 15, -1416354905), v,
                        p, e[n + 5], 21, -57434055), h = d(h, v = d(v, p = d(p, f, h, v, e[
                            n + 12], 6, 1700485571), f, h, e[n + 3], 10, -1894986606), p, f,
                        e[n + 10], 15, -1051523), v, p, e[n + 1], 21, -2054922799), h = d(h, v =
                        d(v, p = d(p, f, h, v, e[n + 8], 6, 1873313359), f, h, e[n + 15], 10, -
                            30611744), p, f, e[n + 6], 15, -1560198380), v, p, e[n + 13], 21,
                    1309151649), h = d(h, v = d(v, p = d(p, f, h, v, e[n + 4], 6, -145523070),
                    f, h, e[n + 11], 10, -1120210379), p, f, e[n + 2], 15, 718787259), v, p, e[
                    n + 9], 21, -343485551), p = o(p, r), f = o(f, i), h = o(h, a), v = o(v, u);
                return [p, f, h, v]
            }
            ...
            function m(e, t) {
                return function (e, t) {
                    var n, r, i = f(e),
                        o = [],
                        a = [];
                    for (o[15] = a[15] = void 0, i.length > 16 && (i = u(i, 8 * e.length)), n = 0; n <
        ...
        e.exports = function () {
            ...
            var e = function (e, t) {
                ...
                t = ["23AC69", "91C132", "F19726", "E8552D", "1AAB8E", "E1147F", "2980C1", "1BA1E6",
            ...
            ! function (t) {
                ...
                function l(e) {
                    return e.replace(/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi, function (e, t) {
                        return "colon" === (t = t.toLowerCase()) ? ":" : "#" === t.charAt(0) ?
                            "x" === t.charAt(1) ? String.fromCharCode(parseInt(t.substring(
                ...
                function c(e, t) {
                    return e = e.source || e, t = t || "", {
                        replace: function (t, n) {
                            return n = (n = n.source || n).replace(/(^|[^\[])\^/g, "$1"), e =
                                e.replace(t, n), this
                        },
                        getRegex: function () {
                ...
                function p(e) {
                    for (var t, n, r = 1; r < arguments.length; r++)
                        for (n in t = arguments[r]) Object.prototype.hasOwnProperty.call(t, n) && (
                            e[n] = t[n]);
                    return e
                }
                ...
                v.def = c(v.def).replace("label", v._label).replace("title", v._title).getRegex(),
                    v.bullet = /(?:[*+-]|\d+\.)/, v.item =
                    /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, v.item = c(v.item, "gm").replace(
                        /bull/g, v.bullet).getRegex(), v.list = c(v.list).replace(/bull/g, v.bullet)
                    .replace("hr",
                        "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace(
                    ...
                    v.tables = p({}, v.gfm, {
                        ...
                        for (var n, r, i, o, a, s, l, c, d, u, p, h, g; e;)
                            ...
                            for (e = e.substring(i[0].length), p = (o = i[2]).length > 1, this.tokens
                                .push({
                                    type: "list_start",
                                    ordered: p,
                                    start: p ? +o : ""
                                }), n = !1, u = (i = i[0].match(this.rules.item)).length, c = 0; c <
                                u; c++) l = (s = i[c]).length, ~(s = s.replace(/^ *([*+-]|\d+\.) +/,
                                    "")).indexOf("\n ") && (l -= s.length, s = this.options.pedantic ?
                                    s.replace(/^ {1,4}/gm, "") : s.replace(new RegExp("^ {1," + l +
                                        "}", "gm"), "")), this.options.smartLists && c !== u - 1 &&
                                (o === (a = v.bullet.exec(i[c + 1])[0]) || o.length > 1 && a.length >
                                    1 || (e = i.slice(c + 1).join("\n") + e, c = u - 1)), r = n ||
                                /\n\n(?!\s*$)/.test(s), c !== u - 1 && (n = "\n" === s.charAt(s.length -
                                    1), r || (r = n)), g = void 0, (h = /^\[[ xX]\] /.test(s)) && (
                                    g = " " !== s[1], s = s.replace(/^\[[ xX]\] +/, "")), this.tokens
                                .push({
                ...
                g.autolink = c(g.autolink).replace("scheme", g._scheme).replace("email", g._email).getRegex(),
                    ...
                    g.normal = p({}, g), g.pedantic = p({}, g.normal, {
                        ...
                        for (var t, n, i, o, a, l = ""; e;)
                            ...
                            i = "@" === a[2] ? "mailto:" + (n = s(this.mangle(a[1]))) : n = s(a[1]),
                            ...
                            "@" === a[2] ? i = "mailto:" + (n = s(a[0])) : (n = s(a[0]), i = "www." ===
                                a[1] ? "http://" + n : n), l += this.renderer.link(i, null, n);
                        return l
        ...
        function o(e, t) {
            ...
            if ("top" === e.insertAt) r ? r.nextSibling ? n.insertBefore(t, r.nextSibling) : n.appendChild(
                t) : n.insertBefore(t, n.firstChild), m.push(t);
            else {
        ...
        function d(e, t) {
            ...
            if (t.singleton) {
                ...
                typeof btoa ? (n = l(t), r = function (e, t, n) {
                    var r = n.css,
                        i = n.sourceMap,
        ...
        e.exports = function (e, t) {
            ...
            (t = t || {}).attrs = "object" == typeof t.attrs ? t.attrs : {}, t.singleton || (t.singleton =
                f()), t.insertInto || (t.insertInto = "head"), t.insertAt || (t.insertAt =
                "bottom");
            var n = i(e, t);
            return r(n, t),
                function (e) {
        ...
        e.exports = function (e) {
            ...
            return e.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (e, t) {
                ...
                return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/)/i.test(o) ? e : (i = 0 ===
                    o.indexOf("//") ? o : 0 === o.indexOf("/") ? n + o : r + o.replace(
